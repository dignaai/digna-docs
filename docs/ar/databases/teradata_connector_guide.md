...
description: قم بتكوين digna للاتصال بـ Teradata باستخدام برنامج التشغيل teradatasql الخاص بـ Python أو برنامج تشغيل Teradata ODBC. يدعم المصادقة بواسطة كلمة المرور مع إعدادات DSN أو بدون DSN.
...
> ⚠️ لأساليب مصادقة أخرى، يرجى استخدام برنامج تشغيل ODBC.
