---
title: موصل Databricks مع Unity Catalog – تكامل قاعدة البيانات | توثيق digna
description: تكوين *digna* للاتصال بـ Databricks باستخدام Unity Catalog عبر الموصل الأصلي لـ Python أو برنامج تشغيل ODBC. يدعم المصادقة عبر الرموز (token) وخيارات اتصال مرنة.
