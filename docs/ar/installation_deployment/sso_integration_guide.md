---
title: دليل تكامل تسجيل الدخول الموحد (SSO) | توثيق digna
description: دليل خطوة بخطوة لتكوين تسجيل الدخول الموحد (SSO) لـ digna باستخدام OpenID Connect (OIDC). يغطي إعداد لوحة التحكم والواجهة الخلفية، الاختبار، استكشاف الأخطاء وإصلاحها، ومزودي الهوية المدعومين بما في ذلك Microsoft Entra ID و Google Workspace و Okta.
...
lang: ar
robots: index, follow
og_title: دليل تكامل تسجيل الدخول الموحد (SSO) لـ digna
og_description: قم بتكوين تسجيل الدخول الموحد لـ digna باستخدام OpenID Connect. إعداد خطوة بخطوة لـ Microsoft Entra ID و Google Workspace و Okta ومزودي الهوية المتوافقين مع OIDC.
