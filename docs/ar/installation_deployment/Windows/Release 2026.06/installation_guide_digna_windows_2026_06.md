---
title: دليل التثبيت على Windows – إصدار digna 2026.06 | توثيق digna
description: دليل خطوة بخطوة لتثبيت إصدار digna 2026.06 على Windows — متطلبات النظام، إعداد PostgreSQL، تكوين خادم الويب، إعداد الواجهة الخلفية واللوحة، تشغيل digna كخدمة Windows، والترقية إلى إصدار جديد.
