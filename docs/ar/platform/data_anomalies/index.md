---
title: digna Data Anomalies | المراقبة المعتمدة على الذكاء الاصطناعي للبيانات
description: digna Data Anomalies هي جزء من منصة digna Data Observability. تتعلم تلقائيًا أنماط بياناتك وتكشف الشذوذ لتحسين جودة البيانات وقابلية المراقبة عبر قواعد البيانات وبحيرات البيانات والمستودعات.
tags:
  - data quality
  - data observability
  - quality of data
