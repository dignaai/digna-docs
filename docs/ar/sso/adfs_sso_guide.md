---
title: AD FS SSO – تكامل تسجيل الدخول الموحد | توثيق digna
description: تكوين تسجيل الدخول الموحد لـ digna باستخدام Active Directory Federation Services عبر OpenID Connect — مجموعة التطبيق، تطبيق الخادم، السر المشترك، النطاقات المسموح بها وتكوين digna المطابق.
image: /assets/logo_square.png
keywords: digna sso, adfs sso, خدمات توحيد الدليل النشط, adfs oidc, مجموعة التطبيق, openid connect, مزود هوية محلي
---
