---
title: Okta SSO – تكامل تسجيل الدخول الموحد | توثيق digna
description: قم بتكوين تسجيل الدخول الموحد (Single Sign-On) لـ digna باستخدام Okta عبر OpenID Connect — تكامل التطبيق، عناوين URI لإعادة التوجيه بعد تسجيل الدخول، بيانات اعتماد العميل، اختيار خادم التفويض وتكوين digna المطابق.
image: /assets/logo_square.png
keywords: digna sso, okta sso, okta oidc, تكامل التطبيق, خادم التفويض, OpenID Connect, المصادقة المؤسسية
---
