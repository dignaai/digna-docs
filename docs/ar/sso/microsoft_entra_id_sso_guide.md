---
title: Microsoft Entra ID SSO – تكامل تسجيل الدخول الأحادي | توثيق digna
description: تكوين تسجيل الدخول الأحادي (Single Sign-On) لـ digna باستخدام Microsoft Entra ID (المعروف سابقًا باسم Azure AD) عبر OpenID Connect — تسجيل التطبيق، URI التحويل، السر الخاص بالعميل، معرف المستأجر وتهيئة digna المطابقة.
image: /assets/logo_square.png
keywords: digna sso, Microsoft Entra ID, Azure AD SSO, تكامل OIDC, تسجيل التطبيق, مصادقة المؤسسات
---
