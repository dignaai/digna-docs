---
title: OneLogin SSO – تكامل تسجيل الدخول الموحد | توثيق digna
description: قم بتكوين تسجيل الدخول الموحد (Single Sign-On) لـ digna باستخدام OneLogin عبر OpenID Connect — إنشاء تطبيق OIDC، عناوين إعادة التوجيه، بيانات اعتماد العميل، مصادقة نقطة نهاية التوكن وتكوين digna المطابق.
image: /assets/logo_square.png
keywords: digna sso, onelogin sso, onelogin oidc, openid connect, مصادقة نقطة نهاية التوكن, مصادقة مؤسسية
---
