---
title: تكامل Keycloak SSO – تسجيل الدخول الأحادي | توثيق digna
description: إعداد تسجيل الدخول الأحادي (SSO) لـ digna باستخدام Keycloak عبر OpenID Connect — إعداد الـ realm والعميل، مصادقة العميل، عناوين إعادة التوجيه الصالحة، سر العميل وتكوين digna المطابق.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, عميل سري, openid connect, مزود هوية مستضاف ذاتيًا
---
