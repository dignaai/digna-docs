---
title: digna CLI Referenz 2026.01 – Befehle & Beispiele | digna Dokumentation
description: Vollständige Referenz für digna CLI Release 2026.01. Erfahren Sie, wie Sie Benutzer, Repositories und Daten mit Befehlen wie add-user, check-config, check-repo-connection, inspect, inspect-async und mehr verwalten.
