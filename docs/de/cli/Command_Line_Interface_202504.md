...
description: Vollständige Referenz für digna CLI Release 2025.04. Erfahren Sie, wie Sie Benutzer, Repositories und Daten mit Befehlen wie add-user, check-repo-connection, upgrade-repo, inspect und weiteren verwalten.
