...
description: Single Sign-On für digna mit PingOne über OpenID Connect konfigurieren — OIDC Web-App-Einrichtung, Redirect-URIs, Client-Credentials, Umgebungs‑ID, regionale Domains und die passende digna-Konfiguration.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, umgebungs-id, openid connect, unternehmensauthentifizierung
---
