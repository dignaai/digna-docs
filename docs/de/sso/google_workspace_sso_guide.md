...
description: Konfigurieren Sie Single Sign-On für digna mit Google Workspace über OpenID Connect — OAuth-Zustimmungsbildschirm, OAuth-Client-ID, autorisierte Redirect-URIs und die passende digna-Konfiguration.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, OAuth-Zustimmungsbildschirm, openid connect, Unternehmensauthentifizierung
---
