...
description: Single Sign-On für digna mit Keycloak über OpenID Connect konfigurieren — Realm- und Client-Einrichtung, Client-Authentifizierung, gültige Redirect-URIs, Client-Geheimnis und die passende digna-Konfiguration.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, vertraulicher Client, openid connect, selbstgehosteter Identitätsanbieter
---
