...
description: Single Sign-On für digna mit OneLogin über OpenID Connect konfigurieren — OIDC-App-Erstellung, Redirect-URIs, Client-Anmeldedaten, Token-Endpoint-Authentifizierung und die passende digna-Konfiguration.
image: /assets/logo_square.png
keywords: digna sso, onelogin sso, onelogin oidc, OpenID Connect, Token-Endpunkt-Authentifizierung, Unternehmensauthentifizierung
---
