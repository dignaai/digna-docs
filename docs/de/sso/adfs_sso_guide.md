...
description: Konfigurieren Sie Single Sign-On für digna mit Active Directory Federation Services über OpenID Connect — Anwendungsgruppe, Serveranwendung, Shared Secret, erlaubte Scopes und die passende digna-Konfiguration.
image: /assets/logo_square.png
keywords: digna sso, adfs sso, Active Directory Federation Services, adfs oidc, Anwendungsgruppe, OpenID Connect, lokaler Identitätsanbieter
---
