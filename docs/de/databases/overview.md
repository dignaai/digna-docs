---
title: Übersicht über Datenbankverbindungen – DSN-lose ODBC-Einrichtung | digna Dokumentation
description: Wie Datenbankverbindungen in digna funktionieren. Jede Quelltechnologie wird über ODBC mit einer DSN-losen Verbindungszeichenfolge aus ODBC-Eigenschaften erreicht. Behandelt die Treiberinstallation auf dem digna-Host, den Bildschirm Add DB Connection, die Verschlüsselung von Eigenschaften, das Testen von Verbindungen, die Fehlersuche und Verweise auf die Anleitungen je Technologie.
...
lang: de
robots: index, follow
og_title: digna Datenbankverbindungen – DSN-lose ODBC-Einrichtung
og_description: Richten Sie eine digna-Quellverbindung über ODBC ohne DSN ein. Treiberinstallation, ODBC-Eigenschaften, Verschlüsselung, Tests und Fehlersuche.
