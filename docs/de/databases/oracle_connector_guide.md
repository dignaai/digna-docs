...
description: Konfigurieren Sie digna für die Verbindung zu Oracle über ODBC mit einer DSN-losen Verbindungszeichenfolge. Behandelt den Oracle-ODBC-Treiber, den DBQ-Connect-Deskriptor, TNS-Aliase und die Verbindungseinstellungen auf digna-Seite.
