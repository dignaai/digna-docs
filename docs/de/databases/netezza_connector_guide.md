...
description: Konfigurieren Sie digna so, dass eine Verbindung zu Netezza über den ODBC-Treiber NetezzaSQL hergestellt wird. Unterstützt passwortbasierte Authentifizierung mit DSN- oder DSN-losen Setups für flexible Konnektivität.
