...
description: Konfigurieren Sie *digna*, damit eine Verbindung zu Teradata über den Python-Treiber `teradatasql` oder den Teradata-ODBC-Treiber hergestellt werden kann. Unterstützt passwortbasierte Authentifizierung mit DSN- oder DSN-less-Konfiguration.
