...
description: Konfigurieren Sie digna so, dass es sich über den nativen PyHive-Treiber oder den Cloudera ODBC-Treiber mit Apache Hive verbindet. Unterstützt passwortbasierte Authentifizierung sowie DSN- und DSN-less-Konfigurationen.
