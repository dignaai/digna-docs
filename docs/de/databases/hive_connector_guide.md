...
description: Konfigurieren Sie digna, um eine Verbindung zu Apache Hive mithilfe des nativen PyHive-Treibers oder des Cloudera ODBC-Treibers herzustellen. Unterstützt passwortbasierte Authentifizierung sowie DSN- oder DSN-less-Konfigurationen.
