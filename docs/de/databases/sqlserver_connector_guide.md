...
description: Konfigurieren Sie digna so, dass eine Verbindung zu Microsoft SQL Server über den pymssql Python-Treiber oder den SQL Server ODBC-Treiber hergestellt wird. Unterstützt kennwortbasierte Authentifizierung mit DSN- oder DSN-losen Setups.
