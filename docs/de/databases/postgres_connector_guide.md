---
title: PostgreSQL-Konnektor – Datenbankintegration | digna Dokumentation
description: Konfigurieren Sie digna, um eine Verbindung zu PostgreSQL über den Python-Treiber psycopg oder den PostgreSQL-ODBC-Treiber herzustellen. Unterstützt passwortbasierte Authentifizierung mit DSN- oder DSN-losen Setups.
