---
title: Data Anomalies – Automatisierte Erkennung von Unregelmäßigkeiten in Daten | digna Dokumentation
description: Erfahren Sie, wie digna Data Anomalies Volumenabfälle, fehlende Werte, Verschiebungen in Verteilungen und unerwartete Muster automatisch erkennt — ganz ohne manuelles Regelwerk. Verbessern Sie die Datenqualität und Beobachtbarkeit von Datenpipelines mit KI-gestützter Anomalieerkennung.
...
lang: en
robots: index, follow
og_title: Data Anomalies – Automated Detection | digna Documentation
og_description: digna Data Anomalies automatically detects irregularities in data volume, values, and distributions without manual rules — improving data quality and observability across platforms.
