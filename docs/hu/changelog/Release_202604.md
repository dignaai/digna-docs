---
title: digna kiadás 2026.04 | Analytics Chart, Enumerations & Validation Rule Templates
description: Tudja meg, mi újság a digna kiadásában 2026.04. Ez a verzió fejlett idősorelemzést vezet be az Analytics Chart segítségével, újrahasznosítható validációs szabály sablonokat, enumerációkat az engedélyezett értékekhez és oszlop szintű relevanciafeltételeket.
keywords: digna kiadás 2026.04, digna változásnapló, digna Data Analytics, idősorelemzés, regresszió, adatvalidáció sablonok, enumerations, engedélyezett értékek ellenőrzése, adatminőségi szabályok, adatmegfigyelés
