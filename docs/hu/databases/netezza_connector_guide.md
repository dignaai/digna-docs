...
description: Konfigurálja a digna-t Netezza-hez való csatlakozáshoz a NetezzaSQL ODBC-illesztőprogram használatával. Támogatja a jelszó alapú hitelesítést DSN vagy DSN nélküli beállításokkal a rugalmas csatlakoztathatóság érdekében.
