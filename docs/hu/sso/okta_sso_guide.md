---
title: Okta SSO – Single Sign-On integráció | digna dokumentáció
description: Állítsa be a Single Sign-On-t (SSO) digna számára Okta és OpenID Connect használatával — alkalmazásintegráció, bejelentkezés átirányítási URI-k, klienshitelesítők, az authorization server kiválasztása és a hozzá illeszkedő digna konfiguráció.
image: /assets/logo_square.png
keywords: digna sso, okta sso, okta oidc, alkalmazásintegráció, authorization server, openid connect, vállalati hitelesítés
---
