---
title: PingOne SSO – Egyetlen bejelentkezés integráció | digna dokumentáció
description: Állítsa be a digna Single Sign-On (SSO) megoldását PingOne segítségével OpenID Connect használatával — OIDC webalkalmazás beállítása, átirányítási URI-k, kliens hitelesítő adatok, Environment ID, regionális domainek és a megfelelő digna konfiguráció.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, environment id, openid connect, vállalati hitelesítés
---
