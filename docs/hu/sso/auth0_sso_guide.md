---
title: Auth0 SSO – Single Sign-On integráció | digna Dokumentáció
description: Állítsa be a Single Sign-On-t a digna számára Auth0-val OpenID Connect használatával — normál webalkalmazás beállítása, engedélyezett callback URL-ek, kliens hitelesítő adatok, tenant domain és a hozzáillő digna konfiguráció.
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, normál webalkalmazás, callback url-ek, openid connect, vállalati hitelesítés
---
