---
title: Google Workspace SSO – Egyszeri bejelentkezés integráció | digna dokumentáció
description: Állítsa be a digna Single Sign-On (SSO) működését Google Workspace-szel OpenID Connect használatával — OAuth hozzájárulási képernyő, OAuth kliensazonosító, engedélyezett átirányítási URI-k és a hozzájuk tartozó digna konfiguráció.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth hozzájárulás, openid connect, vállalati hitelesítés
---
