---
title: Google Workspace SSO – Single Sign-On integrācija | digna dokumentācija
description: Konfigurējiet Single Sign-On (SSO) digna lietotnei ar Google Workspace, izmantojot OpenID Connect — OAuth piekrišanas ekrāns, OAuth klienta ID, autorizētie redirect URI un atbilstošā digna konfigurācija.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth piekrišanas ekrāns, openid connect, uzņēmuma autentifikācija
---
