---
title: Conector MS SQL Server – Integrare bază de date | Documentația digna
description: Configurează digna pentru a se conecta la Microsoft SQL Server folosind driverul Python pymssql sau driverul ODBC pentru SQL Server. Suportă autentificare bazată pe parolă cu configurații DSN sau fără DSN.
