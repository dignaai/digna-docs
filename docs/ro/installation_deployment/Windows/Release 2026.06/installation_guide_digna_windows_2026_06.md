---
title: Ghid de instalare pe Windows – digna Release 2026.06 | digna Documentation
description: Ghid pas cu pas pentru instalarea digna Release 2026.06 pe Windows — cerințe de sistem, configurare PostgreSQL, configurare web server, configurare backend și dashboard, rularea digna ca serviciu Windows și actualizarea la o versiune nouă.
keywords: digna instalare windows, ghid implementare digna, configurare backend digna, instalare dashboard digna, configurare postgresql, serviciu windows digna, ghid upgrade digna
