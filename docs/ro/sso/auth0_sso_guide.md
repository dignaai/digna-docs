---
title: Auth0 SSO – Integrare Single Sign-On | Documentația digna
description: Configurează Single Sign-On pentru digna cu Auth0 folosind OpenID Connect — configurare pentru aplicație web regulată, URL-uri de callback permise, acreditările clientului, domeniul tenantului și configurația digna corespunzătoare.
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, aplicație web regulată, callback urls, openid connect, autentificare enterprise
---
