---
title: Databricks 커넥터(레거시, Unity Catalog 없음) | digna 문서
description: 네이티브 Python 커넥터 또는 Simba Spark ODBC 드라이버를 사용하여 Unity Catalog 없이 Databricks에 연결하도록 digna를 구성하는 방법입니다. 토큰 기반 인증 및 유연한 연결 방식을 지원합니다.
