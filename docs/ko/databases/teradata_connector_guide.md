---
title: Teradata 커넥터 – 데이터베이스 통합 | digna 문서
description: digna를 teradatasql Python 드라이버 또는 Teradata ODBC 드라이버를 사용하여 Teradata에 연결하도록 구성합니다. DSN 또는 DSN-less 설정에서 비밀번호 기반 인증을 지원합니다.
...
> ⚠️ 다른 인증 방법을 사용하려면 ODBC 드라이버를 사용하십시오.
