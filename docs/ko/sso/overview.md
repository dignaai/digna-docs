---
title: Single Sign-On (SSO) 개요 | digna 문서
description: OpenID Connect (OIDC)를 사용해 digna에서 Single Sign-On이 작동하는 방식. 대시보드 및 백엔드 구성, 테스트, 문제 해결, Microsoft Entra ID, Google Workspace, Okta, Auth0, Keycloak, OneLogin, PingOne 및 AD FS별 설정 가이드 링크 포함.
