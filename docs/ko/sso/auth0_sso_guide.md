---
title: Auth0 SSO – 싱글 사인온 통합 | digna 문서
description: OpenID Connect를 사용해 Auth0로 digna의 싱글 사인온을 구성합니다 — Regular Web Application 설정, 허용된 콜백 URL, 클라이언트 자격 증명, 테넌트 도메인 및 일치하는 digna 구성을 다룹니다.
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, regular web application, 콜백 URL, openid connect, 엔터프라이즈 인증
---
