---
title: AD FS SSO – 싱글 사인온 통합 | digna 문서
description: OpenID Connect를 사용하여 Active Directory Federation Services로 digna의 싱글 사인온을 구성합니다 — 애플리케이션 그룹, 서버 애플리케이션, 공유 비밀, 허용된 스코프 및 대응하는 digna 구성.
image: /assets/logo_square.png
keywords: digna sso, adfs sso, Active Directory Federation Services, adfs oidc, 애플리케이션 그룹, OpenID Connect, 온프레미스 아이덴티티 제공자
---
