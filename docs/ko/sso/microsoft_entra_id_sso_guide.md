---
title: Microsoft Entra ID SSO – 싱글 사인온 통합 | digna 문서
description: OpenID Connect를 사용하여 Microsoft Entra ID(이전 Azure AD)로 digna의 싱글 사인온을 구성 — 앱 등록, 리디렉트 URI, 클라이언트 시크릿, 테넌트 ID 및 대응하는 digna 구성.
image: /assets/logo_square.png
keywords: digna sso, microsoft entra id, azure ad sso, oidc 통합, 앱 등록, 엔터프라이즈 인증
---
