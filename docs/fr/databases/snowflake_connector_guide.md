---
title: Connecteur Snowflake – Intégration de base de données | Documentation digna
description: Configurez digna pour se connecter à Snowflake en utilisant le connecteur Python ou le driver ODBC Snowflake. Prend en charge l'authentification par mot de passe avec des configurations DSN ou sans DSN.
...
> ⚠️ Pour d'autres méthodes d'authentification, utilisez le driver ODBC.
