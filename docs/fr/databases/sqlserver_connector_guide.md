---
title: Connecteur MS SQL Server – Intégration de base de données | digna Documentation
description: Configurez digna pour se connecter à Microsoft SQL Server via ODBC avec une chaîne de connexion sans DSN. Couvre le pilote ODBC Microsoft, les propriétés ODBC requises, les paramètres de chiffrement et les paramètres de connexion côté digna.
