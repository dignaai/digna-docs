---
title: Connecteur Teradata – Intégration de base de données | digna Documentation
description: Configurez digna pour se connecter à Teradata via ODBC avec une chaîne de connexion sans DSN. Couvre le pilote ODBC Teradata, la propriété DBCNAME, les mécanismes de connexion et les paramètres de connexion côté digna.
