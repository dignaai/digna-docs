---
title: Connecteur Teradata – Intégration de base de données | Documentation digna
description: Configurez digna pour se connecter à Teradata en utilisant le pilote Python teradatasql ou le pilote ODBC Teradata. Prend en charge l'authentification par mot de passe avec des configurations DSN ou sans DSN.
