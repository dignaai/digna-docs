...
description: Configurez digna pour se connecter à Azure Synapse Analytics via ODBC avec une chaîne de connexion sans DSN. Prend en charge les pools SQL serverless et dédiés, avec les propriétés ODBC requises et les paramètres de connexion côté digna.
