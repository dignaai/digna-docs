---
title: Connecteur Apache Hive – Intégration de base de données | digna Documentation
description: Configurez digna pour se connecter à Apache Hive via ODBC avec une chaîne de connexion sans DSN. Couvre le pilote ODBC Cloudera Hive, les mécanismes d'authentification, les modes de transport et les paramètres de connexion côté digna.
