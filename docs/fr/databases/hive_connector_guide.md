---
title: Connecteur Apache Hive – Intégration de base de données | documentation digna
description: Configurer digna pour se connecter à Apache Hive en utilisant le pilote PyHive natif ou le pilote ODBC Cloudera. Prend en charge l'authentification par mot de passe et les configurations avec ou sans DSN.
