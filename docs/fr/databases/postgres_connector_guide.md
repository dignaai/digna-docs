...
description: Configure digna pour se connecter à PostgreSQL en utilisant le pilote Python psycopg ou le pilote ODBC PostgreSQL. Prend en charge l'authentification par mot de passe avec une configuration DSN ou sans DSN.
