---
title: PingOne SSO – Intégration Single Sign-On | Documentation digna
description: Configurez l'authentification Single Sign-On pour digna avec PingOne en utilisant OpenID Connect — configuration de l'application OIDC web, URI de redirection, identifiants client, ID d'environnement, domaines régionaux et configuration correspondante pour digna.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, identifiant d'environnement, openid connect, authentification entreprise
---
