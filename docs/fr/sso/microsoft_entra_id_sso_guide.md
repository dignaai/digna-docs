---
title: Microsoft Entra ID SSO – Intégration Single Sign-On | Documentation digna
description: Configurez la connexion unique (Single Sign-On) pour digna avec Microsoft Entra ID (anciennement Azure AD) en utilisant OpenID Connect — enregistrement de l'application, URI de redirection, client secret, ID du tenant et la configuration correspondante pour digna.
image: /assets/logo_square.png
keywords: digna sso, microsoft entra id, azure ad sso, intégration oidc, enregistrement d'application, authentification d'entreprise
---
