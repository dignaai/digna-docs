---
title: Configuration SSO Google Workspace – Intégration Single Sign-On | documentation digna
description: Configurez l'authentification unique (Single Sign-On) pour digna avec Google Workspace en utilisant OpenID Connect — écran de consentement OAuth, identifiant client OAuth, URI de redirection autorisés et la configuration digna correspondante.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, écran de consentement oauth, openid connect, authentification d'entreprise
---
