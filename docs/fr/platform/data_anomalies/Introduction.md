---
title: Data Anomalies – Détection automatisée des irrégularités dans les données | Documentation digna
description: Découvrez comment digna Data Anomalies détecte automatiquement les baisses de volume, les valeurs manquantes, les dérives de distribution et les motifs inattendus sans écrire de règles manuelles. Améliorez la qualité des données et l'observabilité des pipelines de données grâce à la détection d'anomalies pilotée par l'IA.
...
keywords:
  ...
  - surveillance du volume de données
  - dérive de distribution
  - fiabilité des données
  - digna data anomalies
lang: fr
robots: index, follow
og_title: Data Anomalies – Détection automatisée | Documentation digna
og_description: digna Data Anomalies détecte automatiquement les irrégularités de volume, de valeurs et de distributions sans règles manuelles — améliorant la qualité et l'observabilité des données sur toutes les plateformes.
