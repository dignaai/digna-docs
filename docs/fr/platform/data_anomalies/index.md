---
title: digna Data Anomalies | Observabilité des données pilotée par l'IA
description: digna Data Anomalies fait partie de la digna Data Observability Platform. Il apprend automatiquement les schémas dans vos données et détecte les anomalies pour améliorer la qualité des données et l'observabilité à travers les bases de données, data lakes et entrepôts.
tags:
  - data quality
  - data observability
  - quality of data
