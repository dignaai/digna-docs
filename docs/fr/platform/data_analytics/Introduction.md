---
title: Data Analytics – Tendances, stabilité et insights à long terme | Documentation digna
description: Découvrez comment digna Data Analytics révèle les tendances à long terme, la volatilité et la stabilité des données à travers les KPI. Détectez les changements dans la qualité et l'observabilité des données, repérez les anomalies cachées et transformez les statistiques en informations exploitables.
...
lang: fr
robots: index, follow
og_title: Data Analytics – Tendances, stabilité et insights à long terme | Documentation digna
og_description: digna Data Analytics détecte les tendances à long terme, la volatilité et la stabilité des données. Découvrez comment surveiller les KPI, détecter la dérive et transformer les statistiques en insights actionnables.
...
<h1 style="display:none;">Module Data Analytics piloté par l'IA pour la qualité et l'observabilité des données – digna</h1>
...
1. **Données d'entrée** – digna collecte des métriques en séries temporelles depuis d'autres modules (par ex., nombre d'anomalies).  
2. **Modélisation statistique** – l'IA et des fonctions statistiques identifient les tendances sous-jacentes et les niveaux de volatilité.  
3. **Comparaison entre périodes** – digna compare les performances historiques et actuelles des KPI ou indicateurs de qualité.  
4. **Génération d'insights** – les tableaux de bord affichent les tendances détectées, les périodes stables et les points de changement dans *Inspection Hub* et les vues analytiques.  
