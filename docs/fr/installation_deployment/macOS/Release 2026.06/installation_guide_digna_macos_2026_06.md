---
title: Guide d'installation macOS – digna Release 2026.06 | Documentation digna
description: Guide pas à pas pour installer digna Release 2026.06 sur macOS — prérequis système, configuration de Homebrew et PostgreSQL, configuration de nginx ou Apache, configuration du backend et du tableau de bord, exécution de digna en tant que service d'arrière-plan et mise à niveau vers une nouvelle version.
keywords: installation digna macos, guide de déploiement digna mac, configuration backend digna, installation dashboard digna, postgresql homebrew, nginx macos, service launchd digna, guide de mise à niveau digna
...
### Étape 4 : Installer le schéma du dépôt
...
Ceci crée un utilisateur avec l'adresse e-mail `admin@example.com` et des privilèges administratifs complets.
...
!!! note "Le serveur occupe le terminal"
    ...
    `serve` s'exécute au premier plan et continue de tourner jusqu'à ce que vous l'arrêtiez avec ++ctrl+c++. Laissez-le tourner pendant que vous terminez la configuration ; pour le démarrer automatiquement au démarrage, voir [Exécuter digna en tant que service en arrière-plan](#running-digna-as-a-background-service).
...
#### Étape 6 : Mettre à niveau le schéma du dépôt
