---
title: digna Version 2026.04 | Analytics Chart, Énumérations & Modèles de règles de validation
description: Découvrez les nouveautés de la version digna 2026.04. Cette version introduit une analyse avancée des séries chronologiques avec Analytics Chart, des modèles réutilisables de règles de validation, des énumérations pour la standardisation des valeurs et des conditions de pertinence au niveau des colonnes.
keywords: digna Version 2026.04, digna changelog, digna Data Analytics, analyse séries temporelles, régression, modèles de validation des données, énumérations, validation des valeurs autorisées, règles de qualité des données, observabilité des données
