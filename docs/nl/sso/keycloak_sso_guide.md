---
title: Keycloak SSO – Single Sign-On-integratie | digna Documentatie
description: Configureer Single Sign-On voor digna met Keycloak via OpenID Connect — realm- en clientconfiguratie, client-authenticatie, geldige redirect-URI's, client secret en de bijbehorende digna-configuratie.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, confidential client, openid connect, zelfgehoste identiteitsprovider
---
