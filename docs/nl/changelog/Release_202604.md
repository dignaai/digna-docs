---
title: digna Release 2026.04 | Analytics Chart, Enumeraties & Validatieregel-sjablonen
description: Ontdek wat nieuw is in digna Release 2026.04. Deze versie introduceert geavanceerde tijdreeksanalyse met Analytics Chart, herbruikbare validatieregel-sjablonen, enumeraties voor toegestane waarden en relevantievoorwaarden op kolomniveau.
keywords: digna Release 2026.04, digna changelog, digna Data Analytics, tijdreeksanalyse, regressie, data validatie sjablonen, enumeraties, validatie toegestane waarden, data kwaliteit regels, data observability
