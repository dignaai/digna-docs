...
description: Configureer digna om verbinding te maken met Teradata met behulp van de teradatasql Python-driver of de Teradata ODBC-driver. Ondersteunt wachtwoordgebaseerde authenticatie met DSN- of DSN-loze configuraties.
