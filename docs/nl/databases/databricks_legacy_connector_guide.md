---
title: Databricks Connector (Legacy, zonder Unity Catalog) | digna Documentatie
description: Configureer digna om te verbinden met Databricks zonder Unity Catalog met de native Python-connector of de Simba Spark ODBC-driver. Ondersteunt token-gebaseerde authenticatie en flexibele connectiviteit.
