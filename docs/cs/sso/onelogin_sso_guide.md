---
title: OneLogin SSO – Integrace Single Sign-On | Dokumentace digna
description: Nakonfigurujte Single Sign-On pro digna s OneLogin pomocí OpenID Connect — vytvoření OIDC aplikace, redirect URI, klientské přihlašovací údaje, autentizace token endpointu a odpovídající konfigurace digna.
image: /assets/logo_square.png
keywords: digna sso, onelogin sso, onelogin oidc, OpenID Connect, autentizace token endpointu, podniková autentizace
---
