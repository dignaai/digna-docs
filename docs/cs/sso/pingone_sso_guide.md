---
title: PingOne SSO – Integrace Single Sign-On | dokumentace digna
description: Nakonfigurujte Single Sign-On pro digna s PingOne pomocí OpenID Connect — nastavení OIDC web app, přesměrovací URI, přihlašovací údaje klienta, ID prostředí, regionální domény a odpovídající konfigurace digna.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, ID prostředí, openid connect, podnikové ověřování
---
