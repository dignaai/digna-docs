---
title: Auth0 SSO – Integrace Single Sign-On | dokumentace digna
description: Nakonfigurujte Single Sign-On pro digna pomocí Auth0 a OpenID Connect — nastavení pro běžnou webovou aplikaci, povolené callback URL, klientské údaje, doména tenanta a odpovídající konfigurace v digna.
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, pravidelná webová aplikace, callback urls, openid connect, enterprise autentizace
---
