---
title: digna Vydání 2026.01 | Logické zdroje dat, globální připojení a pokročilá validace dat
description: Zjistěte, co je nového ve vydání digna 2026.01. Tato verze přináší globální připojení k databázím, logické zdroje dat, podmínky relevance anomálií, exporty CSV a pokročilou validaci dat včetně kontrol referenční integrity.
keywords: digna Release 2026.01, digna changelog, digna datasource, digna database connections, digna Data Anomalies, digna Data Validation, referenční integrita, pravidla kvality dat, data observability, digna CSV export
