---
title: Guía de instalación en macOS – digna Release 2026.06 | Documentación de digna
description: Guía paso a paso para instalar digna Release 2026.06 en macOS — requisitos del sistema, configuración de Homebrew y PostgreSQL, configuración de nginx o Apache, configuración del backend y del dashboard, ejecución de digna como servicio en segundo plano y actualización a una nueva versión.
keywords: digna instalación macos, guía de despliegue digna mac, configuración backend digna, instalación dashboard digna, postgresql homebrew, nginx macos, servicio launchd digna, guía de actualización digna
