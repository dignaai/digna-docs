---
title: PingOne SSO – Integración Single Sign-On | Documentación de digna
description: Configure Single Sign-On para digna con PingOne usando OpenID Connect — configuración de la aplicación OIDC web, URIs de redirección, credenciales de cliente, ID de entorno, dominios regionales y la configuración correspondiente en digna.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, ID de entorno, OpenID Connect, autenticación empresarial
---
