---
title: Okta SSO – Integración de Single Sign-On | Documentación de digna
description: Configura Single Sign-On para digna con Okta usando OpenID Connect — integración de la aplicación, URIs de redirección de inicio de sesión, credenciales de cliente, elección del servidor de autorización y la configuración correspondiente en digna.
image: /assets/logo_square.png
keywords: digna sso, okta sso, okta oidc, integración de aplicaciones, servidor de autorización, openid connect, autenticación empresarial
---
