---
title: SSO de Google Workspace – Integración Single Sign-On | Documentación de digna
description: Configure Single Sign-On para digna con Google Workspace usando OpenID Connect — pantalla de consentimiento OAuth, ID de cliente OAuth, URIs de redireccionamiento autorizadas y la configuración correspondiente de digna.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth consent screen, openid connect, autenticación empresarial
---
