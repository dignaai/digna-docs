---
title: Auth0 SSO – Integración de inicio de sesión único | Documentación de digna
description: Configura inicio de sesión único para digna con Auth0 usando OpenID Connect — configuración para aplicaciones web regulares, URLs de callback permitidas, credenciales de cliente, dominio del tenant y la configuración correspondiente en digna.
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, regular web application, callback urls, openid connect, autenticación empresarial
---
