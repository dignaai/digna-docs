---
title: Descripción general de las conexiones de base de datos – Configuración ODBC sin DSN | digna Documentación
description: Cómo funcionan las conexiones de base de datos en digna. A cada tecnología de origen se llega mediante ODBC con una cadena de conexión sin DSN construida a partir de propiedades ODBC. Cubre la instalación del controlador en el host de digna, la pantalla Add DB Connection, el cifrado de propiedades, la prueba de conexiones, la resolución de problemas y los enlaces a las guías por tecnología.
...
lang: es
robots: index, follow
og_title: Conexiones de base de datos de digna – Configuración ODBC sin DSN
og_description: Configure una conexión de origen de digna mediante ODBC sin DSN. Instalación del controlador, propiedades ODBC, cifrado, pruebas y resolución de problemas.
