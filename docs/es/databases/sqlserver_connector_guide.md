---
title: Conector MS SQL Server – Integración de bases de datos | digna Documentación
description: Configure digna para conectarse a Microsoft SQL Server mediante ODBC con una cadena de conexión sin DSN. Cubre el controlador ODBC de Microsoft, las propiedades ODBC necesarias, los ajustes de cifrado y los ajustes de conexión del lado de digna.
