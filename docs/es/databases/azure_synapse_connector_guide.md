---
title: Conector Azure Synapse – Integración de bases de datos | digna Documentación
description: Configure digna para conectarse a Azure Synapse Analytics mediante ODBC con una cadena de conexión sin DSN. Admite grupos SQL serverless y dedicados, con las propiedades ODBC necesarias y los ajustes de conexión del lado de digna.
