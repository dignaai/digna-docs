---
title: Conector Oracle – Integración de bases de datos | digna Documentación
description: Configure digna para conectarse a Oracle mediante ODBC con una cadena de conexión sin DSN. Cubre el controlador ODBC de Oracle, el descriptor de conexión DBQ, los alias TNS y los ajustes de conexión del lado de digna.
