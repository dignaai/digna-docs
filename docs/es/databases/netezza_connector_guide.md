---
title: Conector Netezza – Integración de bases de datos | digna Documentación
description: Configure digna para conectarse a Netezza mediante ODBC con una cadena de conexión sin DSN. Cubre el controlador NetezzaSQL, las propiedades ODBC necesarias y los ajustes de conexión del lado de digna.
