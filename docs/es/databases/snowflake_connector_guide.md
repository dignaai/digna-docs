---
title: Conector de Snowflake – Integración de Base de Datos | Documentación de digna
description: Configure digna para conectarse a Snowflake usando el conector de Python o el driver ODBC de Snowflake. Soporta autenticación basada en contraseña con configuraciones con DSN o sin DSN.
...
> ⚠️ Para otros métodos de autenticación, por favor use el driver ODBC.
