---
title: Conector Apache Hive – Integración de bases de datos | digna Documentación
description: Configure digna para conectarse a Apache Hive mediante ODBC con una cadena de conexión sin DSN. Cubre el controlador ODBC de Cloudera para Hive, los mecanismos de autenticación, los modos de transporte y los ajustes de conexión del lado de digna.
