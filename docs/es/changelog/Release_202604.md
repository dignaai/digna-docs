---
title: digna Release 2026.04 | Analytics Chart, Enumerations y Plantillas de Reglas de Validación
description: Descubre las novedades de digna Release 2026.04. Esta versión introduce análisis avanzado de series temporales con Analytics Chart, plantillas reutilizables de reglas de validación, enumeraciones para valores permitidos y condiciones de relevancia a nivel de columna.
keywords: digna Release 2026.04, registro de cambios digna, digna Data Analytics, análisis de series temporales, regresión, plantillas de validación de datos, enumeraciones, validación de valores permitidos, reglas de calidad de datos, observabilidad de datos
