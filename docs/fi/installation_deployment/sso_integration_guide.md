---
title: Single Sign-On (SSO) -integraatio-opas | digna-dokumentaatio
description: Vaiheittainen opas Single Sign-Onin (SSO) määrittämiseen digna:lle käyttämällä OpenID Connectia (OIDC). Kattaa dashboardin ja backendin konfiguroinnin, testauksen, vianmäärityksen ja tuetut identiteetin tarjoajat kuten Microsoft Entra ID, Google Workspace ja Okta.
...
lang: fi
robots: index, follow
og_title: digna Single Sign-On (SSO) -integraatio-opas
og_description: Määritä Single Sign-On digna:lle käyttäen OpenID Connectia. Vaiheittainen asennus Microsoft Entra ID:n, Google Workspacen, Okta:n ja muiden OIDC-yhteensopivien identiteetin tarjoajien kanssa.
