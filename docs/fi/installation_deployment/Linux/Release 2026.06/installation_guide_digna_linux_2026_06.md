---
title: Linux-asennusopas – digna Release 2026.06 | digna-dokumentaatio
description: Askel askeleelta -opas digna Release 2026.06 -version asentamiseen Linuxissa — järjestelmävaatimukset, PostgreSQL:n asetukset, nginx- tai Apache-konfiguraatio, backendin ja dashboardin määritys, dignan ajaminen systemd-palveluna ja päivitys uuteen julkaisuun.
keywords: digna linux asennus, digna käyttöönotto-opas, digna backend asennus, digna dashboard asennus, postgresql linux, nginx linux, digna systemd palvelu, digna päivitysohje
...
### Vaihe 3: Alusta repositorioyhteys
...
!!! note "Palvelin varaa päätteen"
    ...
    `serve` toimii edustalla ja jatkaa, kunnes pysäytät sen näppäinyhdistelmällä ++ctrl+c++. Anna sen olla käynnissä, kun viimeistelet asennuksen; automaattisen käynnistyksen osalta katso [dignan suorittaminen systemd-palveluna](#running-digna-as-a-systemd-service).
