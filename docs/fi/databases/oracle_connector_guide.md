---
title: Oracle-liitin – tietokantaintegraatio | digna-dokumentaatio
description: Konfiguroi digna yhdistämään Oracleen käyttäen python-oracledb-ajuria tai Oracle ODBC -ajuria. Tukee salasanaperusteista todennusta sekä DSN- että DSN-loseja määrityksiä.
