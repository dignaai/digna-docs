---
title: Keycloak SSO – Single Sign-On -integraatio | digna-dokumentaatio
description: Määritä Single Sign-On dignalle Keycloakin avulla käyttäen OpenID Connectiä — kehyksen (realm) ja clientin asetukset, clientin todennus, hyväksytyt redirect-URI:t, client-salaisuus ja vastaava digna-konfiguraatio.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, confidential client, OpenID Connect, itseisännöity identiteetin tarjoaja
---
