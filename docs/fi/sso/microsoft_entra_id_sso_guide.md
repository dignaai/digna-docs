---
title: Microsoft Entra ID SSO – Single Sign-On -integraatio | digna-dokumentaatio
description: Määritä Single Sign-On dignalle Microsoft Entra ID:n (entinen Azure AD) avulla käyttäen OpenID Connectiä — sovelluksen rekisteröinti, redirect URI, client secret, tenant ID ja vastaava digna-konfiguraatio.
image: /assets/logo_square.png
keywords: digna sso, Microsoft Entra ID, Azure AD SSO, OIDC-integraatio, sovellusrekisteröinti, yritystason autentikointi
---
