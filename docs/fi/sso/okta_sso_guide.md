---
title: Okta SSO – Single Sign-On -integraatio | digna-dokumentaatio
description: Määritä Single Sign-On (SSO) dignalle Oktaa käyttäen OpenID Connect -protokollaa — sovellusin­tegraatio, kirjautumisen uudelleenohjaus-URI:t, client credentials, authorization server -valinta ja vastaava digna-konfiguraatio.
image: /assets/logo_square.png
keywords: digna sso, okta sso, okta oidc, sovellusin­tegraatio, authorization server, openid connect, yritystason todennus
---
