---
title: Auth0 SSO – Single Sign-On -integraatio | digna-dokumentaatio
description: Määritä Single Sign-On dignalle Auth0:n kanssa käyttäen OpenID Connectiä — tavallisen web-sovelluksen asetukset, sallitut callback-URL:t, asiakastiedot, tenantin domain ja vastaava digna-konfiguraatio.
