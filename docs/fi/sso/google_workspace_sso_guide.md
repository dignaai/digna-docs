---
title: Google Workspace SSO – Single Sign-On -integraatio | digna-dokumentaatio
description: Määritä Single Sign-On (SSO) dignalle Google Workspacen avulla OpenID Connectia käyttäen — OAuth-suostumusnäyttö, OAuth-asiakastunnus, valtuutetut uudelleenohjaus-URI:t ja vastaava digna-konfiguraatio.
image: /assets/logo_square.png
keywords: digna sso, Google Workspace SSO, Google OIDC, OAuth-suostumusnäyttö, OpenID Connect, yritystason todennus
---
