---
title: AD FS SSO – Single Sign-On -integraatio | digna-dokumentaatio
description: Konfiguroi Single Sign-On dignalle Active Directory Federation Servicesin avulla käyttäen OpenID Connectiä — sovellusryhmä, palvelinsovellus, jaettu salaisuus, sallitut scopet ja vastaava digna-konfiguraatio.
image: /assets/logo_square.png
keywords: digna sso, adfs sso, active directory federation services, adfs oidc, sovellusryhmä, openid connect, paikallinen identiteetin tarjoaja
---
