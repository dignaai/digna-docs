---
title: Databricks-anslutning med Unity Catalog – Databasintegration | digna-dokumentation
description: Konfigurera digna för att ansluta till Databricks med Unity Catalog med den inbyggda Python-connectorn eller ODBC-drivrutinen. Stöder token-baserad autentisering och flexibel uppkoppling.
