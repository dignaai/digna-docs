...
description: Konfigurera digna för att ansluta till Snowflake med Python-connectorn eller Snowflake ODBC-drivrutinen. Stöder lösenordsbaserad autentisering med DSN- eller DSN-lösa konfigurationer.
