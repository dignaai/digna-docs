...
description: Konfigurera digna för att ansluta till Oracle med python-oracledb-drivrutinen eller Oracle ODBC-drivrutinen. Stöder lösenordsbaserad autentisering med DSN- eller DSN-fria inställningar.
