...
description: Konfigurera digna för att ansluta till PostgreSQL med psycopg Python-drivrutinen eller PostgreSQL ODBC-drivrutinen. Stöder lösenordsbaserad autentisering med DSN- eller DSN-lösa konfigurationer.
