---
title: Teradata-anslutning – Databasintegration | digna-dokumentation
description: Konfigurera digna för att ansluta till Teradata med teradatasql Python-drivrutinen eller Teradata ODBC-drivrutinen. Stöder lösenordsbaserad autentisering med DSN eller DSN-lösa uppsättningar.
