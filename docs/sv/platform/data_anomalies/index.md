---
title: digna Data Anomalies | AI-baserad observabilitet av data
description: digna Data Anomalies är en del av digna Data Observability Platform. Den lär sig automatiskt mönster i dina data och upptäcker avvikelser för att förbättra datakvaliteten och observabiliteten över databaser, data lakes och datalager.
tags:
  - data quality
  - data observability
  - quality of data
