---
title: Google Workspace SSO – Single Sign-On-integrering | digna Dokumentation
description: Konfigurera Single Sign-On för digna med Google Workspace via OpenID Connect — OAuth-samtyckesskärm, OAuth-klient-ID, auktoriserade redirect-URI:er och motsvarande digna-konfiguration.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth consent screen, openid connect, företagsautentisering
---
