...
description: Konfigurera Single Sign-On för digna med Active Directory Federation Services via OpenID Connect — applikationsgrupp, serverapplikation, delad hemlighet, tillåtna scopes och motsvarande digna-konfiguration.
image: /assets/logo_square.png
keywords: digna sso, adfs sso, Active Directory Federation Services, adfs oidc, applikationsgrupp, OpenID Connect, lokal identitetsleverantör
---
