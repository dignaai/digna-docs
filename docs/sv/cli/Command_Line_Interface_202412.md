---
title: digna CLI-referens 2024.12 – Kommandon & Exempel | digna-dokumentation
description: Komplett referens för digna CLI-release 2024.12. Lär dig hur du hanterar användare, repositories och data med kommandon som add-user, check-repo-connection, upgrade-repo, inspect med mera.
