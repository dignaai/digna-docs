---
title: Conector PostgreSQL – Integração de Banco de Dados | Documentação digna
description: Configure o digna para conectar ao PostgreSQL usando o driver Python psycopg ou o driver ODBC do PostgreSQL. Suporta autenticação por senha com configurações com DSN ou sem DSN.
