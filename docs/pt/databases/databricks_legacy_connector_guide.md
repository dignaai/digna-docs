---
title: Conector Databricks (Legado, sem Unity Catalog) | Documentação digna
description: Configure o *digna* para conectar ao Databricks sem Unity Catalog usando o conector nativo em Python ou o driver ODBC Simba Spark. Suporta autenticação por token e conectividade flexível.
