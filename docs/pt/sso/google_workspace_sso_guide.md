---
title: Google Workspace SSO – Integração Single Sign-On | Documentação digna
description: Configure o Single Sign-On para o digna com o Google Workspace usando OpenID Connect — tela de consentimento OAuth, ID de cliente OAuth, URIs de redirecionamento autorizados e a configuração correspondente do digna.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, tela de consentimento oauth, openid connect, autenticação empresarial
---
