---
title: Google Workspace SSO – integracja Single Sign-On | Dokumentacja digna
description: Skonfiguruj Single Sign-On dla digna z użyciem Google Workspace przez OpenID Connect — ekran zgody OAuth, identyfikator klienta OAuth, autoryzowane redirect URI oraz odpowiadająca konfiguracja digna.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth consent screen, openid connect, uwierzytelnianie przedsiębiorstw
---
