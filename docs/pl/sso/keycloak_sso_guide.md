---
title: Keycloak SSO – Integracja Single Sign-On | Dokumentacja digna
description: Skonfiguruj Single Sign-On dla digna z Keycloak używając OpenID Connect — konfiguracja realm i klienta, uwierzytelnianie klienta, dozwolone URI przekierowań, sekret klienta oraz odpowiadająca konfiguracja digna.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, klient poufny, OpenID Connect, self-hosted identity provider
---
