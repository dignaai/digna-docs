---
title: Konektor PostgreSQL – Integracja baz danych | digna Dokumentacja
description: Skonfiguruj digna do połączenia z PostgreSQL przez ODBC za pomocą ciągu połączenia bez DSN. Obejmuje sterownik psqlODBC, wymagane właściwości ODBC, tryby SSL oraz ustawienia połączenia po stronie digna.
