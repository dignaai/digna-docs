---
title: Konektor Snowflake – Integracja baz danych | digna Dokumentacja
description: Skonfiguruj digna do połączenia ze Snowflake przez ODBC za pomocą ciągu połączenia bez DSN. Obejmuje sterownik ODBC Snowflake, programowe tokeny dostępu, wybór magazynu i roli oraz ustawienia połączenia po stronie digna.
