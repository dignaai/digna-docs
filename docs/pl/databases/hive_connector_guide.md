---
title: Konektor Apache Hive – Integracja baz danych | digna Dokumentacja
description: Skonfiguruj digna do połączenia z Apache Hive przez ODBC za pomocą ciągu połączenia bez DSN. Obejmuje sterownik ODBC Cloudera dla Hive, mechanizmy uwierzytelniania, tryby transportu oraz ustawienia połączenia po stronie digna.
