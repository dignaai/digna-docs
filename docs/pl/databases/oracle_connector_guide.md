---
title: Konektor Oracle – Integracja baz danych | digna Dokumentacja
description: Skonfiguruj digna do połączenia z Oracle przez ODBC za pomocą ciągu połączenia bez DSN. Obejmuje sterownik ODBC Oracle, deskryptor połączenia DBQ, aliasy TNS oraz ustawienia połączenia po stronie digna.
