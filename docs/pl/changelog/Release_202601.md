---
title: digna Wydanie 2026.01 | Logiczne źródła danych, Globalne połączenia i Zaawansowana walidacja danych
description: Dowiedz się, co nowego w wydaniu digna 2026.01. Ta wersja wprowadza globalne połączenia z bazą danych, logiczne źródła danych, warunki istotności anomalii, eksport CSV oraz zaawansowaną walidację danych, w tym sprawdzenia integralności referencyjnej.
keywords: digna Wydanie 2026.01, digna lista zmian, digna datasource, digna połączenia z bazą danych, digna Data Anomalies, digna Data Validation, walidacja integralności referencyjnej, reguły jakości danych, obserwowalność danych, eksport CSV digna
