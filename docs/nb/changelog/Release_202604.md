...
description: Lær hva som er nytt i digna Release 2026.04. Denne versjonen introduserer avansert tidsserieanalyse med Analytics Chart, gjenbrukbare maler for valideringsregler, enumerasjoner for tillatte verdier og relevansbetingelser på kolonnenivå.
keywords: digna Release 2026.04, digna changelog, digna Data Analytics, tidsserieanalyse, regresjon, maler for datavalidering, enumerasjoner, validering av tillatte verdier, regler for datakvalitet, dataobservabilitet
