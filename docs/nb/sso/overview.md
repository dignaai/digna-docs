---
title: Oversikt over Single Sign-On (SSO) | digna Dokumentasjon
description: Hvordan Single Sign-On fungerer i digna ved bruk av OpenID Connect (OIDC). Dekker dashbord- og backend-konfigurasjon, testing, feilsøking og lenker til per-leverandør oppsett for Microsoft Entra ID, Google Workspace, Okta, Auth0, Keycloak, OneLogin, PingOne og AD FS.
