---
title: Microsoft Entra ID SSO – Single Sign-On-integrasjon | digna-dokumentasjon
description: Konfigurer Single Sign-On for digna med Microsoft Entra ID (tidligere Azure AD) ved hjelp av OpenID Connect — appregistrering, redirect URI, client secret, tenant ID og den tilsvarende digna-konfigurasjonen.
image: /assets/logo_square.png
keywords: digna sso, microsoft entra id, azure ad sso, oidc-integrasjon, app-registrering, bedriftsautentisering
---
