---
title: Keycloak SSO – Single Sign-On-integrasjon | digna-dokumentasjon
description: Konfigurer Single Sign-On for digna med Keycloak ved hjelp av OpenID Connect — realm- og klientoppsett, klientautentisering, gyldige redirect-URIer, klienthemmelighet og matchende digna-konfigurasjon.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, konfidensiell klient, openid connect, selv-hostet identitetsleverandør
---
