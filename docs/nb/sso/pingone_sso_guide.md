---
title: PingOne SSO – Single Sign-On-integrasjon | digna-dokumentasjon
description: Konfigurer Single Sign-On for digna med PingOne ved hjelp av OpenID Connect — oppsett av OIDC web app, redirect URIer, klientlegitimasjon, environment ID, regionale domener og tilsvarende digna-konfigurasjon.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, miljø-ID, openid connect, bedriftsautentisering
---
