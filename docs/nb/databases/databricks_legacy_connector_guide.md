---
title: Databricks-tilkobling (Legacy, uten Unity Catalog) | digna-dokumentasjon
description: Konfigurer digna for å koble til Databricks uten Unity Catalog ved hjelp av den native Python-connectoren eller Simba Spark ODBC-driveren. Støtter token-basert autentisering og fleksibel tilkobling.
