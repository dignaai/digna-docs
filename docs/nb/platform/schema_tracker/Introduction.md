...
lang: nb
robots: index, follow
og_title: Data Schema Tracker – Overvåk skjemaendringer | digna-dokumentasjon
og_description: Lær hvordan digna Data Schema Tracker overvåker kolonneendringer, oppdateringer av datatyper og skjemadrift. Få varsler om tilsiktede og utilsiktede endringer for å forhindre ETL-feil og feil i dashbord.
