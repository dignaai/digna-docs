---
title: Data Anomalies – Автоматическое обнаружение аномалий в данных | digna Documentation
description: Узнайте, как модуль digna Data Anomalies автоматически обнаруживает падения объёма, пропущенные значения, сдвиги распределений и неожиданные паттерны без ручного написания правил. Повышайте качество данных и наблюдаемость конвейеров данных с помощью детекции аномалий на базе ИИ.
...
lang: ru
robots: index, follow
og_title: Data Anomalies – Автоматическое обнаружение | digna Documentation
og_description: digna Data Anomalies автоматически обнаруживает аномалии в объёме данных, значениях и распределениях без ручных правил — повышая качество данных и наблюдаемость в разных платформах.
...
<h1 style="display:none;">Модуль на основе ИИ для качества и наблюдаемости данных – digna Data Anomalies</h1>
...
Yes. digna runs fully **локально (on-premises) или в частном облаке** and adheres to European compliance standards.
