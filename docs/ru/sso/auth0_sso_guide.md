---
title: Auth0 SSO – Интеграция Single Sign-On | digna Documentation
description: Настройте Single Sign-On для digna с Auth0 с помощью OpenID Connect — настройка для Regular Web Applications, разрешённые callback URL, учётные данные клиента, домен тенанта и соответствующая конфигурация digna.
