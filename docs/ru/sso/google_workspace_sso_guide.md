---
title: Настройка SSO для Google Workspace — интеграция Single Sign-On | документация digna
description: Настройка единого входа (Single Sign-On) для digna с Google Workspace через OpenID Connect — экран согласия OAuth, OAuth client ID, авторизованные redirect URI и соответствующая конфигурация digna.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth consent screen, openid connect, корпоративная аутентификация
---
