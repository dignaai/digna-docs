---
title: Коннектор Netezza — интеграция с базой данных | документация digna
description: Настройте digna для подключения к Netezza с помощью ODBC‑драйвера NetezzaSQL. Поддерживается аутентификация по паролю как с DSN, так и без DSN для гибкого подключения.
