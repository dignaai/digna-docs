---
title: Коннектор PostgreSQL — интеграция с базой данных | документация digna
description: Настройка digna для подключения к PostgreSQL с использованием Python-драйвера psycopg или драйвера PostgreSQL ODBC. Поддерживается аутентификация по паролю в конфигурациях с DSN и без DSN.
...
> ⚠️ Для других методов аутентификации используйте, пожалуйста, ODBC-драйвер.
