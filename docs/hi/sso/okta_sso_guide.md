---
title: Okta SSO – सिंगल साइन-ऑन एकीकरण | digna प्रलेखन
description: OpenID Connect का उपयोग करके Okta के साथ digna के लिए Single Sign-On कॉन्फ़िगर करें — ऐप एकीकरण, साइन-इन रीडायरेक्ट URI, क्लाइंट क्रेडेंशियल, authorization server का चयन और मिलती-जुलती digna कॉन्फ़िगरेशन।
image: /assets/logo_square.png
keywords: digna sso, okta sso, okta oidc, ऐप एकीकरण, authorization server, openid connect, एंटरप्राइज़ प्रमाणीकरण
---
