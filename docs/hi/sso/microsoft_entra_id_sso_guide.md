---
title: Microsoft Entra ID SSO – सिंगल साइन-ऑन एकीकरण | digna दस्तावेज़
description: OpenID Connect का उपयोग करते हुए Microsoft Entra ID (पूर्व में Azure AD) के साथ digna के लिए Single Sign-On कॉन्फ़िगर करें — ऐप रजिस्ट्रेशन, redirect URI, client secret, tenant ID और संगत digna कॉन्फ़िगरेशन।
