---
title: Auth0 SSO – सिंगल साइन-ऑन एकीकरण | digna प्रलेखन
description: OpenID Connect का उपयोग करके Auth0 के साथ digna के लिए सिंगल साइन-ऑन कॉन्फ़िगर करें — रेगुलर वेब एप्लिकेशन सेटअप, अनुमत callback URLs, क्लाइंट क्रेडेंशियल्स, tenant डोमेन और मिलती-जुलती digna कॉन्फ़िगरेशन।
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, regular वेब एप्लिकेशन, callback urls, openid connect, एंटरप्राइज़ प्रमाणीकरण
---
