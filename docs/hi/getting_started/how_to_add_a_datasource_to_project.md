---
title: एक डेटाबेस कनेक्ट करें | digna दस्तावेज़ीकरण
description: digna में एक मौजूदा प्रोजेक्ट से डेटाबेस कनेक्ट करने के लिए चरण-दर-चरण मार्गदर्शिका। जानें कि कैसे कनेक्शन चुनें, सेटिंग्स कॉन्फ़िगर करें, और सुरक्षित एक्सेस सक्षम करें।
---
