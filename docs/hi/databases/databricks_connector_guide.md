---
title: Databricks कनेक्टर (Unity Catalog के साथ) – डेटाबेस इंटीग्रेशन | digna Documentation
description: नатив Python कनेक्टर या ODBC ड्राइवर का उपयोग करके Unity Catalog के साथ Databricks से कनेक्ट करने के लिए digna को कॉन्फ़िगर करें। टोकन-आधारित प्रमाणीकरण और लचीली कनेक्टिविटी का समर्थन।
