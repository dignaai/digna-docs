---
title: Oracle कनेक्टर – डेटाबेस इंटीग्रेशन | digna दस्तावेज़ीकरण
description: python-oracledb ड्राइवर या Oracle ODBC ड्राइवर का उपयोग करके digna को Oracle से कनेक्ट करने के लिए कॉन्फ़िगर करें। DSN या DSN-less सेटअप के साथ पासवर्ड-आधारित प्रमाणीकरण का समर्थन।
