---
title: Databricks कनेक्टर (Legacy, Unity Catalog के बिना) | digna Documentation
description: नैटिव Python कनेक्टर या Simba Spark ODBC ड्राइवर का उपयोग करके Unity Catalog के बिना Databricks से कनेक्ट करने के लिए digna को कॉन्फ़िगर करें। टोकन-आधारित प्रमाणीकरण और लचीली कनेक्टिविटी का समर्थन करता है।
