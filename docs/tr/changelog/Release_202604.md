---
title: digna Sürüm 2026.04 | Analytics Chart, Enumerations & Doğrulama Kural Şablonları
description: digna Sürüm 2026.04 ile gelen yenilikleri öğrenin. Bu sürüm, Analytics Chart ile gelişmiş zaman serisi analizi, yeniden kullanılabilir doğrulama kuralı şablonları, enumerations ile izin verilen değerlerin merkezi standardizasyonunu ve sütun düzeyinde alaka koşullarını tanıtıyor.
keywords: digna Sürüm 2026.04, digna changelog, digna Data Analytics, zaman serisi analizi, regresyon, veri doğrulama şablonları, enumerations, izin verilen değer doğrulama, veri kalitesi kuralları, veri gözlemlenebilirliği
