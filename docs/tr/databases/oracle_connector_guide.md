---
title: Oracle Bağlayıcısı – Veritabanı Entegrasyonu | digna Dokümantasyonu
description: digna'yı python-oracledb sürücüsü veya Oracle ODBC sürücüsü kullanarak Oracle'a bağlanacak şekilde yapılandırın. DSN veya DSN'siz kurulumlarla parola tabanlı kimlik doğrulamayı destekler.
