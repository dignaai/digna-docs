---
title: Snowflake Bağlayıcısı – Veritabanı Entegrasyonu | digna Dokümantasyonu
description: digna'yı Snowflake'e Python bağlayıcısı veya Snowflake ODBC sürücüsü kullanarak bağlanacak şekilde yapılandırın. DSN veya DSN'siz kurulumlarla parola tabanlı kimlik doğrulamayı destekler.
