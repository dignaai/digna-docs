---
title: Netezza Bağlayıcı – Veritabanı Entegrasyonu | digna Dokümantasyonu
description: digna'yı NetezzaSQL ODBC sürücüsünü kullanarak Netezza'ya bağlanacak şekilde yapılandırın. Esnek bağlantı için DSN veya DSN-less kurulumlarla parola tabanlı kimlik doğrulamayı destekler.
