...
description: Configure digna to connect to Netezza over ODBC with a DSN-less connection string. Covers the NetezzaSQL driver, the required ODBC properties and the digna-side connection settings.
