...
description: Configure digna to connect to Azure Synapse Analytics over ODBC with a DSN-less connection string. Supports serverless and dedicated SQL pools, with the required ODBC properties and digna-side connection settings.
