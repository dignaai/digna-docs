...
description: Configure digna to connect to PostgreSQL over ODBC with a DSN-less connection string. Covers the psqlODBC driver, the required ODBC properties, SSL modes and the digna-side connection settings.
