...
description: Configure digna to connect to Microsoft SQL Server over ODBC with a DSN-less connection string. Covers the Microsoft ODBC driver, the required ODBC properties, encryption settings and the digna-side connection settings.
