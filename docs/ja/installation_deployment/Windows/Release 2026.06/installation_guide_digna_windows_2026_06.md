---
title: Windows インストールガイド – digna リリース 2026.06 | digna ドキュメント
description: Windows に digna リリース 2026.06 をインストールするためのステップバイステップガイド — システム要件、PostgreSQL のセットアップ、Web サーバーの構成、バックエンドとダッシュボードの設定、digna を Windows サービスとして実行する方法、リリースへのアップグレード方法を含む
keywords: digna windows インストール, digna デプロイメント ガイド, digna backend セットアップ, digna dashboard インストール, postgresql セットアップ, digna windows サービス, digna アップグレード ガイド
