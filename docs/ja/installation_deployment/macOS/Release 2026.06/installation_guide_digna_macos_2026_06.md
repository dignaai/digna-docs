---
title: macOS インストールガイド – digna Release 2026.06 | digna ドキュメント
description: macOS に digna Release 2026.06 をインストールする手順ガイド — システム要件、Homebrew と PostgreSQL のセットアップ、nginx または Apache の設定、バックエンドとダッシュボードの構成、digna をバックグラウンドサービスとして実行する方法、リリースのアップグレード手順
keywords: digna macos インストール, digna mac 展開ガイド, digna バックエンド セットアップ, digna ダッシュボード インストール, postgresql homebrew, nginx macos, digna launchd サービス, digna アップグレード ガイド
