---
title: Auth0 SSO – シングルサインオン統合 | digna ドキュメント
description: digna を Auth0 の OpenID Connect でシングルサインオンに設定する手順 — Regular Web Application の設定、許可されたコールバック URL、クライアント認証情報、テナントドメイン、および対応する digna 設定を扱います。
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, regular web application, callback urls, openid connect, エンタープライズ認証
---
