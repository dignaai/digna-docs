---
title: Okta SSO – シングルサインオン統合 | digna ドキュメント
description: OpenID Connect を使用して Okta で digna のシングルサインオンを設定する — アプリ統合、サインインのリダイレクト URI、クライアント資格情報、認可サーバーの選択、および対応する digna の設定。
image: /assets/logo_square.png
keywords: digna SSO, Okta SSO, Okta OIDC, アプリ統合, 認可サーバー, OpenID Connect, エンタープライズ認証
---
