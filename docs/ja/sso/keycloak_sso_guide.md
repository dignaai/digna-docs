---
title: Keycloak SSO – シングルサインオン連携 | digna ドキュメント
description: OpenID Connectを使ってKeycloakでdignaのシングルサインオンを設定する方法 — realmとクライアントの設定、クライアント認証、有効なリダイレクトURI、クライアントシークレット、及びdigna側の設定。
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, confidential client, openid connect, セルフホステッドIDプロバイダー
---
