---
title: PingOne SSO – シングルサインオン統合 | digna ドキュメント
description: PingOneを使ったOpenID Connectによるdignaのシングルサインオンを設定する — OIDC Webアプリの設定、リダイレクトURI、クライアント認証情報、Environment ID、地域ドメイン、およびそれに対応するdignaの設定
image: /assets/logo_square.png
keywords: digna sso, PingOne SSO, Ping Identity, PingOne OIDC, 環境ID, OpenID Connect, エンタープライズ認証
---
