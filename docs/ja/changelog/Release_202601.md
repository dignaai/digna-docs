---
title: digna リリース 2026.01 | 論理データソース、グローバル接続、先進的なデータ検証
description: digna リリース 2026.01 の新機能を紹介します。本バージョンではグローバルなデータベース接続、論理データソース、異常関連条件、CSVエクスポート、および参照整合性チェックを含む高度なデータ検証を導入します。
