---
title: Teradata コネクタ – データベース統合 | digna ドキュメント
description: teradatasql Python ドライバーまたは Teradata ODBC ドライバーを使って digna を Teradata に接続するように設定します。DSN または DSN-less の構成でパスワード認証に対応しています。
