---
title: digna Data Anomalies | AIによるデータの可観測性
description: digna Data Anomalies は digna Data Observability Platform の一部です。データベース、データレイク、データウェアハウス全体でデータの品質と可観測性を向上させるため、データのパターンを自動で学習し、異常を検出します。
tags:
  - データ品質
  - データ可観測性
  - データの品質
