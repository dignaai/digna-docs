---
title: Конектор Databricks (Legacy, без Unity Catalog) | документація digna
description: Налаштуйте digna для підключення до Databricks без Unity Catalog, використовуючи нативний Python-конектор або Simba Spark ODBC драйвер. Підтримується автентифікація на основі токена та гнучкі варіанти підключення.
