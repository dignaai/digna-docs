---
title: Snowflake Connector – інтеграція бази даних | документація digna
description: Налаштуйте digna для підключення до Snowflake за допомогою Python-конектора або ODBC-драйвера. Підтримується автентифікація за паролем у конфігураціях з DSN або без DSN.
...
> ⚠️ Для інших методів автентифікації, будь ласка, використовуйте ODBC-драйвер.
