---
title: Підключення Databricks з Unity Catalog — інтеграція бази даних | документація digna
description: Налаштуйте digna для підключення до Databricks з Unity Catalog за допомогою рідного Python-конектора або ODBC-драйвера. Підтримується автентифікація на основі токена та гнучкі варіанти підключення.
