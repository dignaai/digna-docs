---
title: Реліз digna 2026.04 | Analytics Chart, Переліки та шаблони правил валідації
description: Дізнайтеся про нове в релізі digna 2026.04. У цій версії з'явився розширений аналіз часових рядів за допомогою Analytics Chart, багаторазові шаблони правил валідації, перелічення (enumerations) для дозволених значень та умови релевантності на рівні стовпця.
keywords: реліз digna 2026.04, digna changelog, digna Data Analytics, аналіз часових рядів, регресія, шаблони валідації даних, переліки, валідація дозволених значень, правила якості даних, моніторинг даних
