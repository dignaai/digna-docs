---
title: Keycloak SSO – Ενοποίηση Single Sign-On | digna Documentation
description: Ρυθμίστε το Single Sign-On για το digna με Keycloak χρησιμοποιώντας OpenID Connect — ρύθμιση realm και client, authentication client, valid redirect URIs, client secret και η αντίστοιχη ρύθμιση στο digna.
