---
title: OneLogin SSO – Ενσωμάτωση Single Sign-On | τεκμηρίωση digna
description: Διαμορφώστε το Single Sign-On για το digna με OneLogin χρησιμοποιώντας OpenID Connect — δημιουργία εφαρμογής OIDC, redirect URIs, διαπιστευτήρια πελάτη, έλεγχος ταυτότητας token endpoint και η αντίστοιχη ρύθμιση για digna.
