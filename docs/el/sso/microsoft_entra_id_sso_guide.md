---
title: Microsoft Entra ID SSO – Ενσωμάτωση Single Sign-On | τεκμηρίωση digna
description: Ρυθμίστε το Single Sign-On για το digna με το Microsoft Entra ID (πρώην Azure AD) χρησιμοποιώντας OpenID Connect — εγγραφή εφαρμογής, redirect URI, client secret, tenant ID και η αντίστοιχη ρύθμιση στο digna.
image: /assets/logo_square.png
keywords: digna sso, microsoft entra id, azure ad sso, ενσωμάτωση OIDC, εγγραφή εφαρμογής, εταιρική πιστοποίηση
---
