---
title: Google Workspace SSO – Ενοποίηση Single Sign-On | Τεκμηρίωση digna
description: Διαμορφώστε το Single Sign-On για την digna με το Google Workspace χρησιμοποιώντας το OpenID Connect — οθόνη συναίνεσης OAuth, OAuth client ID, εξουσιοδοτημένα redirect URIs και η αντίστοιχη διαμόρφωση digna.
