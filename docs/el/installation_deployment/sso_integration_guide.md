---
title: Οδηγός Ενσωμάτωσης Single Sign-On (SSO) | digna Documentation
description: Βήμα προς βήμα οδηγίες για τη διαμόρφωση του Single Sign-On (SSO) για το digna χρησιμοποιώντας OpenID Connect (OIDC). Καλύπτει διαμόρφωση dashboard και backend, δοκιμές, αντιμετώπιση προβλημάτων και υποστηριζόμενους παρόχους ταυτότητας όπως Microsoft Entra ID, Google Workspace και Okta.
...
og_description: Διαμορφώστε Single Sign-On για το digna χρησιμοποιώντας OpenID Connect. Οδηγίες βήμα προς βήμα για Microsoft Entra ID, Google Workspace, Okta και άλλους OIDC-συμβατούς παρόχους ταυτότητας.
