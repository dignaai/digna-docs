---
title: Συνδετήρας Teradata – Ενσωμάτωση Βάσης Δεδομένων | digna Documentation
description: Διαμορφώστε το digna για σύνδεση σε Teradata χρησιμοποιώντας τον Python driver teradatasql ή τον Teradata ODBC driver. Υποστηρίζει αυθεντικοποίηση με κωδικό πρόσβασης με ρυθμίσεις DSN ή χωρίς DSN.
