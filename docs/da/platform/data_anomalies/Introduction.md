---
title: Data Anomalies – Automatisk detektion af uregelmæssigheder i data | digna Dokumentation
description: Lær hvordan digna Data Anomalies automatisk opdager fald i volumen, manglende værdier, forandringsskift i fordelinger og uventede mønstre uden manuel regelkodning. Forbedr datakvalitet og observabilitet i datapipelines med AI-drevet anomalidetektion.
image: /assets/logo_square.png
keywords:
  - data-anomalier
  - AI-anomali-detektion
  - overvågning af datakvalitet
  - datakvalitet
  - observabilitet af data
  - registrering af manglende data
  - overvågning af datavolumen
  - distribution drift
  - pålidelighed af data
  - digna data anomalies
lang: da
robots: index, follow
og_title: Data Anomalies – Automatisk detektion | digna Dokumentation
og_description: digna Data Anomalies opdager automatisk uregelmæssigheder i datavolumen, værdier og fordelinger uden manuelle regler — hvilket forbedrer datakvaliteten og observabiliteten på tværs af platforme.
