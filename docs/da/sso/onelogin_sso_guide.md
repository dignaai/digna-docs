---
title: OneLogin SSO – Single Sign-On-integration | digna-dokumentation
description: Konfigurer Single Sign-On for digna med OneLogin ved hjælp af OpenID Connect — oprettelse af OIDC-app, redirect URIs, klientoplysninger, token-endpoint-autentificering og den tilsvarende digna-konfiguration.
image: /assets/logo_square.png
keywords: digna sso, onelogin sso, onelogin oidc, openid connect, token endpoint-autentificering, enterprise-autentificering
---
