...
description: Konfigurér Single Sign-On for digna med Microsoft Entra ID (tidligere Azure AD) ved hjælp af OpenID Connect — app-registrering, redirect URI, client secret, tenant ID og den matchende digna-konfiguration.
image: /assets/logo_square.png
keywords: digna sso, microsoft entra id, azure ad sso, oidc integration, app-registrering, virksomhedsautentificering
---
