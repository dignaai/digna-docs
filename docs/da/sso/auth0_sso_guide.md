...
description: Konfigurer Single Sign-On for digna med Auth0 ved hjælp af OpenID Connect — opsætning for almindelig webapplikation, tilladte callback-URL'er, klientlegitimationsoplysninger, tenant-domæne og den tilsvarende digna-konfiguration.
