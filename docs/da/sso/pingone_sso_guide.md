---
title: PingOne SSO – Single Sign-On-integration | digna Dokumentation
description: Konfigurer Single Sign-On for digna med PingOne ved hjælp af OpenID Connect — OIDC webapp-opsætning, redirect-URI'er, klientoplysninger, environment ID, regionale domæner og den tilsvarende digna-konfiguration.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, environment id, OpenID Connect, virksomhedsgodkendelse
---
