---
title: MS SQL Server Connector – Databaseintegration | digna-dokumentation
description: Konfigurer digna til at oprette forbindelse til Microsoft SQL Server ved hjælp af pymssql Python-driveren eller SQL Server ODBC-driveren. Understøtter adgangskodebaseret autentificering med DSN eller DSN-less opsætninger.
