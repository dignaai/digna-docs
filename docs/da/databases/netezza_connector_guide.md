...
description: Konfigurer digna til at forbinde til Netezza ved hjælp af NetezzaSQL ODBC-driveren. Understøtter adgangskodebaseret autentificering med DSN eller DSN-less opsætninger for fleksibel tilslutning.
