---
title: Linux-installationsvejledning – digna Release 2026.06 | digna-dokumentation
description: Trin-for-trin vejledning til installation af digna Release 2026.06 på Linux — systemkrav, PostgreSQL-opsætning, nginx eller Apache-konfiguration, backend- og dashboard-konfiguration, kørsel af digna som systemd-service og opgradering til en ny release.
keywords: digna linux installation, digna udrulningsvejledning, digna backend-opsætning, digna dashboard-installation, postgresql linux, nginx linux, digna systemd service, digna opgraderingsvejledning
