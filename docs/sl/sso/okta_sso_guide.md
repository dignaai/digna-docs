---
title: Okta SSO – Integracija Single Sign-On | digna Dokumentacija
description: Konfigurirajte Single Sign-On za digna z Okta preko OpenID Connect — integracija aplikacije, preusmeritveni URI-ji za prijavo, poverilnice klienta, izbira avtentikacijskega strežnika in ustrezna digna konfiguracija.
image: /assets/logo_square.png
keywords: digna sso, okta sso, okta oidc, integracija aplikacije, avtentikacijski strežnik, openid connect, podjetna avtentikacija
---
