---
title: macOS Navodila za namestitev – digna izdaja 2026.06 | digna Dokumentacija
description: Korak‑po‑korak navodila za namestitev digna izdaje 2026.06 na macOS — sistemske zahteve, nastavitev Homebrew in PostgreSQL, konfiguracija nginx ali Apache, konfiguracija backend‑a in nadzorne plošče, zagon digna kot ozadnega servisa ter nadgradnja na novo izdajo.
keywords: digna namestitev macos, digna vodnik za namestitev mac, digna backend namestitev, digna dashboard namestitev, postgresql homebrew, nginx macos, digna launchd servis, digna vodnik za nadgradnjo
...
!!! note "Strežnik zaseda terminal"
    ...
    `serve` teče v ospredju in deluje, dokler ga ne ustavite s ++ctrl+c++. Pustite ga teči, dokler ne dokončate namestitve; če naj se namesto tega samodejno zaganja ob zagonu sistema, glejte [Zagon digna kot Storitve v Ozadju](#running-digna-as-a-background-service).
