---
title: Vodnik za integracijo Single Sign-On (SSO) | digna Dokumentacija
description: Korak za korakom vodnik za konfiguracijo Single Sign-On (SSO) za digna z uporabo OpenID Connect (OIDC). Vključuje konfiguracijo na nadzorni plošči in v backendu, testiranje, odpravljanje napak in podprte identitne ponudnike, vključno z Microsoft Entra ID, Google Workspace in Okta.
...
lang: sl
robots: index, follow
og_title: digna Vodnik za integracijo Single Sign-On (SSO)
og_description: Konfigurirajte Single Sign-On za digna z uporabo OpenID Connect. Korak za korakom nastavitev za Microsoft Entra ID, Google Workspace, Okta in druge OIDC-kompatibilne identitne ponudnike.
