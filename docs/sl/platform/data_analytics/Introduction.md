...
lang: sl
robots: index, follow
og_title: Data Analytics – Trendi, stabilnost in dolgoročni vpogledi | digna Dokumentacija
og_description: digna Data Analytics zaznava dolgoročne trende, nihajnost in stabilnost v podatkih. Odkrijte, kako spremljati KPI-je, zaznavati drift in pretvoriti statistiko v uporabne poslovne vpoglede.
...
1. **Input Data** – digna zbira metrike časovnih vrst iz drugih modulov (npr. število anomalij).  
2. **Statistical Modeling** – AI in statistične funkcije identificirajo osnovne trende in ravni nihajnosti.  
3. **Comparison Across Periods** – digna primerja zgodovinsko in trenutno uspešnost za KPI-je ali indikatorske metrike kakovosti.  
4. **Insights Generation** – nadzorne plošče prikazujejo zaznane trende, stabilna obdobja in točke sprememb v *Inspection Hub* in analitičnih pogledih.  
