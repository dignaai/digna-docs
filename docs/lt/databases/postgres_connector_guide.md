---
title: PostgreSQL Connector – Duomenų bazės integracija | digna Dokumentacija
description: Konfigūruokite digna ryšiui su PostgreSQL naudojant psycopg Python draiverį arba PostgreSQL ODBC draiverį. Palaikomas autentifikavimas su slaptažodžiu naudojant DSN arba be DSN.
