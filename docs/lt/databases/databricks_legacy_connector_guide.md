---
title: Databricks jungtis (Legacy, be Unity Catalog) | digna dokumentacija
description: Sujunkite digna su Databricks be Unity Catalog, naudojant vietinį Python jungtį arba Simba Spark ODBC driverį. Palaiko autentifikaciją su tokenu ir lanksčias prisijungimo galimybes.
...
> ⚠️ Jei norite naudoti kitus autentifikacijos metodus, prašome naudoti ODBC driverį.
