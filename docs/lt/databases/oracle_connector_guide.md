---
title: Oracle Connector – Duomenų bazės integracija | digna dokumentacija
description: Konfigūruokite digna, kad prisijungtų prie Oracle naudojant python-oracledb arba Oracle ODBC tvarkyklę. Palaikomas autentifikavimas tik su slaptažodžiu, tiek per DSN, tiek be DSN.
