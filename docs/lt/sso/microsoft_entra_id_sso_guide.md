---
title: Microsoft Entra ID SSO – Vieno prisijungimo integracija | digna dokumentacija
description: Konfigūruokite vieno prisijungimo (Single Sign-On) funkciją digna naudojant Microsoft Entra ID (anksčiau Azure AD) per OpenID Connect — programos registracija, redirect URI, kliento slaptasis raktas, tenant ID ir atitinkama digna konfigūracija.
image: /assets/logo_square.png
keywords: digna sso, microsoft entra id, azure ad sso, oidc integracija, programos registracija, įmonės autentifikavimas
---
