---
title: Keycloak SSO – Vieno prisijungimo (Single Sign-On) integracija | digna dokumentacija
description: Konfigūruokite digna vieno prisijungimo (SSO) naudojant Keycloak per OpenID Connect — realm ir kliento nustatymai, kliento autentifikacija, galiojančios peradresavimo URI, kliento slaptasis raktas ir atitinkama digna konfigūracija.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, konfidencialus klientas, openid connect, savarankiškai talpinamas tapatybės tiekėjas
---
