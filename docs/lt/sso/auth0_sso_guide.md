---
title: Auth0 SSO – Vienkartinio prisijungimo integracija | digna dokumentacija
description: Konfigūruokite vienkartinį prisijungimą (SSO) digna su Auth0 naudojant OpenID Connect — paprastasis žiniatinklio programos nustatymas, leistini grąžinimo URL, kliento kredencialai, nuomininko domenas ir atitinkama digna konfigūracija.
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, reguliarus žiniatinklio taikymas, callback URL'ai, openid connect, įmonės autentifikacija
---
