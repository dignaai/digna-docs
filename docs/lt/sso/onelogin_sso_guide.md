---
title: OneLogin SSO – Vienkartinio prisijungimo (SSO) integracija | digna dokumentacija
description: Sukonfigūruokite vienkartinį prisijungimą (SSO) digna su OneLogin naudojant OpenID Connect — OIDC programos kūrimas, peradresavimo URI, kliento kredencialai, tokenų endpoint autentifikacija ir atitinkama digna konfigūracija.
image: /assets/logo_square.png
keywords: digna sso, onelogin sso, onelogin oidc, OpenID Connect, token endpoint authentication, įmonės autentifikacija
---
