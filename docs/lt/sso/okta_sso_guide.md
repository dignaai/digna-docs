---
title: Okta SSO – Vieningo prisijungimo integracija | digna documentation
description: Sukonfigūruokite Vieningą prisijungimą (Single Sign-On) digna naudojant Okta per OpenID Connect — programos integracija, prisijungimo peradresavimo URI, kliento kredencialai, autorizacijos serverio pasirinkimas ir atitinkama digna konfigūracija.
image: /assets/logo_square.png
keywords: digna SSO, okta SSO, okta OIDC, programos integracija, autorizacijos serveris, OpenID Connect, įmonės autentifikacija
---
