---
title: Google Workspace SSO – Single Sign-On integracija | digna dokumentacija
description: Sukonfigūruokite Single Sign-On (SSO) digna su Google Workspace naudojant OpenID Connect — OAuth sutikimo ekraną, OAuth kliento ID, autorizuotus peradresavimo URI ir atitinkamą digna konfigūraciją.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth sutikimo ekranas, openid connect, įmonės autentifikacija
---
