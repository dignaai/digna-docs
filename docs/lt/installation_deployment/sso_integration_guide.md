---
title: Single Sign-On (SSO) integracijos vadovas | digna Dokumentacija
description: Žingsnis po žingsnio vadovas, kaip sukonfigūruoti Single Sign-On (SSO) digna naudojant OpenID Connect (OIDC). Apima informacijas apie dashboard ir backend konfigūraciją, testavimą, trikčių šalinimą ir palaikomus identiteto tiekėjus, tokius kaip Microsoft Entra ID, Google Workspace ir Okta.
...
lang: en
robots: index, follow
og_title: digna Single Sign-On (SSO) integracijos vadovas
og_description: Sukonfigūruokite Single Sign-On digna naudojant OpenID Connect. Žingsnis po žingsnio nustatymai Microsoft Entra ID, Google Workspace, Okta ir kitiems OIDC suderinamiems identiteto tiekėjams.
