...
This page documents the full set of commands available in ***digna*** CLI release **2024.12**, including usage examples and options.
...
1. **Displaying General Help:**
    ...
    Naudokite --help tiesiogiai po raktažodžio `dignacli`  
   ```bash
   dignacli --help
   ```
...
3.  **Getting Help for Specific Commands:**  
    ...
    Daugiau informacijos apie konkretų komandą gausite pridėję `--help` prie tos komandos.
    Pavyzdžiui, kad gauti pagalbą su komanda `add-user`, vykdykite:
     ```bash
     ...
     - **Command Description:** Išsamiai aprašo, ką atlieka komanda.  
     - **Syntax:** Rodo tikslią sintaksę, įskaitant privalomus ir pasirenkamus argumentus.  
     - **Options:** Išvardina bet kokias komandos specifines parinktis ir jų paaiškinimus.  
     - **Examples:** Pateikia pavyzdžius, kaip efektyviai vykdyti komandą.  
