---
title: Data Anomalies – Automatizuotas netaisyklingumų aptikimas duomenyse | digna Dokumentacija
description: Sužinokite, kaip digna Data Anomalies automatiškai aptinka apimties kritimus, trūkstamas reikšmes, pasiskirstymo poslinkius ir netikėtus modelius be rankinio taisyklių rašymo. Pagerinkite duomenų kokybę ir duomenų srautų stebimumą naudodami dirbtiniu intelektu pagrįstą anomalijų aptikimą.
...
lang: lt
robots: index, follow
og_title: Data Anomalies – Automatizuotas aptikimas | digna Dokumentacija
og_description: digna Data Anomalies automatiškai aptinka netaisyklingumus duomenų apimtyje, reikšmėse ir pasiskirstymuose be rankinių taisyklių — gerindama duomenų kokybę ir stebimumą visose platformose.
