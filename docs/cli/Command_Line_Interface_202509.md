...
```bash
*digna*cli inspect-status <REQUEST ID>
```
...
```bash
*digna*cli inspect-status 12345
```
...
```bash
*digna*cli inspect-cancel <REQUEST ID>
*digna*cli inspect-cancel --killall
...
```bash
*digna*cli inspect-cancel 12345
```
