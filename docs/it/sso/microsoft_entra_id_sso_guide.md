---
title: Microsoft Entra ID SSO – Integrazione Single Sign-On | Documentazione digna
description: Configura il Single Sign-On per digna con Microsoft Entra ID (precedentemente Azure AD) usando OpenID Connect — registrazione dell'app, redirect URI, client secret, tenant ID e la corrispondente configurazione di digna.
image: /assets/logo_square.png
keywords: digna sso, microsoft entra id, azure ad sso, integrazione oidc, registrazione app, autenticazione aziendale
---
