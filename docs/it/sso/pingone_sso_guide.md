---
title: PingOne SSO – Integrazione Single Sign-On | Documentazione digna
description: Configura il Single Sign-On per digna con PingOne usando OpenID Connect — configurazione dell'app OIDC web, redirect URI, credenziali client, ID dell'ambiente, domini regionali e la corrispondente configurazione di digna.
image: /assets/logo_square.png
keywords: digna sso, pingone sso, ping identity, pingone oidc, id ambiente, openid connect, autenticazione enterprise
---
