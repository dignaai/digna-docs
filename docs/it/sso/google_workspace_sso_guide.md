---
title: Google Workspace SSO – Integrazione Single Sign-On | Documentazione digna
description: Configura Single Sign-On per digna con Google Workspace usando OpenID Connect — schermata di consenso OAuth, client ID OAuth, URI di reindirizzamento autorizzati e la corrispondente configurazione di digna.
image: /assets/logo_square.png
keywords: digna sso, google workspace sso, google oidc, oauth schermata consenso, openid connect, autenticazione aziendale
---
