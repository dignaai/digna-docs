---
title: Auth0 SSO – Integrazione Single Sign-On | Documentazione digna
description: Configura il Single Sign-On per digna con Auth0 usando OpenID Connect — configurazione per applicazioni web regolari, URL di callback consentiti, credenziali client, dominio del tenant e la corrispondente configurazione di digna.
image: /assets/logo_square.png
keywords: digna sso, auth0 sso, auth0 oidc, applicazione web regolare, callback urls, openid connect, autenticazione aziendale
---
