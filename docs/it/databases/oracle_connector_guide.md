---
title: Connettore Oracle – Integrazione database | digna Documentazione
description: Configura digna per connettersi a Oracle tramite ODBC con una stringa di connessione senza DSN. Copre il driver ODBC di Oracle, il descrittore di connessione DBQ, gli alias TNS e le impostazioni di connessione lato digna.
