---
title: Connettore Oracle – Integrazione Database | digna Documentation
description: Configura digna per connettersi a Oracle usando il driver python-oracledb o il driver ODBC di Oracle. Supporta l'autenticazione basata su password con configurazioni DSN o senza DSN.
