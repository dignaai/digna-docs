---
title: Connettore PostgreSQL – Integrazione database | digna Documentazione
description: Configura digna per connettersi a PostgreSQL tramite ODBC con una stringa di connessione senza DSN. Copre il driver psqlODBC, le proprietà ODBC necessarie, le modalità SSL e le impostazioni di connessione lato digna.
