---
title: Connettore Netezza – Integrazione database | digna Documentazione
description: Configura digna per connettersi a Netezza tramite ODBC con una stringa di connessione senza DSN. Copre il driver NetezzaSQL, le proprietà ODBC necessarie e le impostazioni di connessione lato digna.
