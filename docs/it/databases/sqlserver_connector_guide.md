---
title: Connettore MS SQL Server – Integrazione Database | Documentazione digna
description: Configura digna per connettersi a Microsoft SQL Server usando il driver Python pymssql o il driver ODBC di SQL Server. Supporta l'autenticazione basata su password con configurazioni DSN o senza DSN.
...
> ⚠️ Per altri metodi di autenticazione, utilizzare il driver ODBC.
