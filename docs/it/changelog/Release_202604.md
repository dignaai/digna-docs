...
description: Scopri le novità di digna Release 2026.04. Questa versione introduce analisi avanzate delle serie temporali con Analytics Chart, template riutilizzabili per regole di validazione, enumerazioni per valori ammessi e condizioni di rilevanza a livello di colonna.
keywords: digna Release 2026.04, digna changelog, digna Data Analytics, analisi serie temporali, regressione, template di validazione dati, enumerazioni, validazione valori ammessi, regole qualità dei dati, osservabilità dei dati
