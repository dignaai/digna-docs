---
title: Anomaly Tuning – Prediction and Alert Dials | digna Documentation
description: Reference for tuning digna anomaly detection. Threshold Configuration sets the width of the tolerance band with Sensitivity and Memory; Model Configuration exposes seven prediction dials covering break detection, outlier rejection, memory, gap tolerance, and plausibility clamping.
...
lang: en
robots: index, follow
og_title: Anomaly Tuning – Prediction and Alert Dials | digna Documentation
og_description: How to tune digna anomaly detection — Sensitivity, Memory, and the seven Model Configuration dials, with guidance on which to reach for.
