---
title: Data Validation – How It Works | digna Documentation
description: How digna Data Validation works — the three rule kinds (rule expressions, uniqueness, referential integrity), how each becomes SQL, absolute and relative thresholds, rule templates, enumerations, and failed-record inspection.
...
lang: en
robots: index, follow
og_title: Data Validation – How It Works | digna Documentation
og_description: The mechanics of digna Data Validation — three rule kinds, how each becomes SQL, threshold modes, and failed-record inspection.
