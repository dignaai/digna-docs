...
keywords:
  ...
  - arrival prediction
  - data freshness
  - schedule rule daily weekly monthly
...
lang: en
robots: index, follow
og_title: Data Timeliness – How It Works | digna Documentation
og_description: The mechanics of digna Timeliness — what counts as a delivery, AI and rule modes, the alert margin, and missed-delivery detection.
