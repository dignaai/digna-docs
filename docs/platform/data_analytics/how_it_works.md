---
title: Data Analytics – How It Works | digna Documentation
description: How digna Data Analytics works — a regression fitted over a configurable window of profiled statistics, producing absolute and relative change and volatility, evaluated against user-defined limits.
...
lang: en
robots: index, follow
og_title: Data Analytics – How It Works | digna Documentation
og_description: The mechanics of digna Data Analytics — regression over a window of profiled statistics, four derived metrics, and user-defined limits.
