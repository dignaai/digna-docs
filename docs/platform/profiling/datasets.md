---
title: Datasets – Filters and Grouping | digna Documentation
description: How digna Datasets split a data source into independently monitored subsets. Static datasets filter with a WHERE condition, Dynamic datasets group with GROUP BY, Hybrid datasets do both — plus relevance rules that suppress a status without suppressing measurement.
image: /assets/logo_square.png
keywords:
  - digna datasets
  - data subset monitoring
  - filter expression
  - grouping expression
...
lang: en
robots: index, follow
og_title: Datasets – Filters and Grouping | digna Documentation
og_description: Static, Dynamic and Hybrid datasets, the filter and grouping expressions behind them, and relevance rules.
