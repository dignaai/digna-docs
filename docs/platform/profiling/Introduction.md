---
title: Profiling – The Foundation of digna | digna Documentation
description: Profiling is the step that measures your data and produces the statistics digna Data Anomalies and digna Data Analytics are built on. It runs as part of those modules, entirely inside your database, and only aggregated numbers ever leave the source.
...
lang: en
robots: index, follow
og_title: Profiling – The Foundation of digna | digna Documentation
og_description: Profiling measures your data in-database and produces the statistics digna Data Anomalies and digna Data Analytics read. Part of those modules, not a separate step.
