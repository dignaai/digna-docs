---
title: Data Anomalies – Automated Detection of Irregularities in Data | digna Documentation
description: Learn how digna Data Anomalies automatically detects volume drops, missing values, distribution shifts, and unexpected patterns without manual rule coding. Improve data quality and observability of data pipelines with AI-driven anomaly detection.
