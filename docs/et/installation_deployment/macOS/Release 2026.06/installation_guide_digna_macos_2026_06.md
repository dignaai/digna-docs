---
title: macOS-i paigaldusjuhend – digna väljalase 2026.06 | digna dokumentatsioon
description: Juhend samm-sammult digna väljalase 2026.06 paigaldamiseks macOS-ile — süsteeminõuded, Homebrew ja PostgreSQL seadistus, nginx või Apache konfiguratsioon, backend'i ja armatuurlaua seadistus, digna käivitamine taustateenusena ning uuendamine uuele versioonile.
keywords: digna macOS paigaldus, digna macOS-i juurutusjuhend, digna backend seadistus, digna dashboard paigaldus, postgresql homebrew, nginx macOS, digna launchd teenus, digna uuendamisjuhend
