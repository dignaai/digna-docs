---
title: OneLogin SSO – Ühekordse sisselogimise integratsioon | digna dokumentatsioon
description: Seadistage digna jaoks OneLogini kaudu ühekordne sisselogimine (Single Sign-On) kasutades OpenID Connecti — OIDC-rakenduse loomine, ümbersuunamise URI-d, kliendi mandaadid, tokeni lõpp-punkti autentimine ja vastav digna konfiguratsioon.
image: /assets/logo_square.png
keywords: digna sso, onelogin sso, onelogin oidc, OpenID Connect, tokeni lõpp-punkti autentimine, ettevõtte autentimine
---
