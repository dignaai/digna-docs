---
title: Keycloak SSO – Single Sign-On integratsioon | digna dokumentatsioon
description: Konfigureeri digna jaoks Single Sign-On Keycloakiga kasutades OpenID Connecti — realm ja kliendi seadistus, kliendi autentimine, kehtivad redirect URI-d, kliendi saladus ja vastav digna konfiguratsioon.
image: /assets/logo_square.png
keywords: digna sso, keycloak sso, keycloak oidc, realm, konfidentsiaalne klient, openid connect, ise majutatud identiteediteenuse pakkuja
---
